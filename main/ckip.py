...
trash_ws = ['板身','來自','台灣','站','”','坊›','板','資訊','批','坊','本板','違反','規定','板務','水桶','檢舉','板規','編輯','我,','你','發信站','我們','板主','板主群','聯絡','站內','內信','網址','坊','實業','實業坊','版規','內文','原文','處罰','水桶''https','imgur','批踢踢','踢踢','看板','文章','刪文','遵守','排版','作者','標題','時間','推','有','是']
